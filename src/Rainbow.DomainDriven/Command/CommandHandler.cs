...
namespace Rainbow.DomainDriven.Command
{
    public class CommandHandler : ICommandHandler
    {
        ...
        private Delegate GetDelegate(Type type)
        {
            ...
            var contextTypeExp = Expression.Parameter(typeof(ICommandContext));
        ...
        protected virtual void HandleInvoke<TCommand>(ICommandContext context, TCommand command) where TCommand : ICommand
        {
